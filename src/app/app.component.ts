...
export class AppComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.facultadService.obtenerFacultad().subscribe(resp => {
  ...
  guardar(): void {
    this.estudianteService.subirArchivo(this.personaForm.value).subscribe(resp => {
      this.personaForm.reset();
      this.estudiantes=this.estudiantes.filter(estudiante=> resp.codigo!==estudiante.codigo);
